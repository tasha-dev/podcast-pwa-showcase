      ...
      <div className={cn("relative", className)}>
         ...
         <AnimatePresence mode="wait" key="dropdown-animate-precense">
            {open && (
               <motion.div
                  key={"dropdown"}
                  className="absolute left-1/2 -translate-x-1/2 top-full translate-y-3 w-full bg-white max-h-[250px] overflow-auto p-2 rounded-lg shadow-lg shadow-black/10 flex flex-col gap-3"
                  transition={{
                     duration: 0.4,
                     ease: "easeInOut",
                  }}
