  ...
  return (
    <>
      <div
        ...
        className={cn(
          "size-40 relative rounded-lg overflow-hidden data-[error=true]:bg-red-500 data-[error=false]:bg-base-light transition-all duration-500 cursor-pointer z-0 outline-0  ring-0 ring-base/40 group",
      ...
      >
        ...
        />
        <div className="size-10 absolute right-3 bottom-3 flex items-center justify-center rounded-full group-data-[error=false]:bg-base group-data-[error=true]:bg-red-800 z-10">
          <Camera className="size-5 text-white" />
        </div>
      </div>
      {errorMessage && (
        <p className="mt-1.5 text-red-500 text-center text-sm font-normal">
          {errorMessage}
        </p>
      )}
    </>
